...
UCLASS()
class VRTEST_API UIOFunctionLibrary : public UBlueprintFunctionLibrary {
	GENERATED_BODY()
public:
	...
	UFUNCTION(BlueprintCallable, Category = "PaulsUtilities | IO")
	static void printMsg(const FString& str) {
		FString msg = "Error: ";
		msg += str;
		GEngine->AddOnScreenDebugMessage(INDEX_NONE, 12.f, FColor::Green, msg);
	}
